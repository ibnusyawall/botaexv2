 ...
 */
var imgbbUploader = function (apiKey, pathToFile) { return __awaiter(void 0, void 0, void 0, function () {
    var base64string;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fileToString_1.fileToString(pathToFile)];
            case 1:
                base64string = _a.sent();
                return [2 /*return*/, postToImgbb_1.postToImgbb(apiKey, base64string)];
        }
    });
}); };
